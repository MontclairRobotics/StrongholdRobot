...
public class CameraServer555 {
  ...
  //private static CameraServer555 server;

  /*public static CameraServer555 getInstance() {
    if (server == null) {
      server = new CameraServer555();
    }
    return server;
  }*/
  ...
  public CameraServer555(String[] camNamesInput) {
  ...
  public void startAutomaticCapture()
  {
	  ...
	  {
		  cams[i]=startAutomaticCapture(camNames[i]);
	  }
	  startAutomaticCapture(cams[0]);
  }
   ...
   */
  public USBCamera startAutomaticCapture(String cameraName) {
    try {
