...
public class Trajectory
{
    ...
    private static final double deltaYCamera=heightOfTarget-CameraXY.heightOfCamera;
    ...
    public static double[] getDegrees(double power)//0 at bottom and height at top
    {
